...
const CloudinaryInputUI: FC<CloudinaryInputUIProps> = ({ label, disabled, onImageSelected, value, fitImage }) => {
  ...
  return (
    <div style={{ marginBottom: 20 }}>
      <input type="file" accept="image/*" style={{ display: "none" }} ref={inputRef} onChange={onFileInputChange} />
      <Card variant="outlined">
        <CardHeader title={label} />
        <CardContent>{value ? <AdvancedImage cldImg={image} width={384} height={240} /> : <Skeleton variant="rectangular" width={384} height={240} />}</CardContent>
        <CardActions>
